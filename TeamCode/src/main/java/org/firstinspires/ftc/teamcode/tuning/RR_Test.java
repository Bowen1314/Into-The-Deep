...
@Autonomous(name = "AAA - Test", group = "A-RR")
public final class RR_Test extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Actions.runBlocking(
                drive.actionBuilder(beginPose)
                        ...
                        .afterTime(0,new ArmAction(leftholder,rightholder,0,1))
                        .waitSeconds(1)
                        .strafeToSplineHeading(new Vector2d(5,28), Math.toRadians(90))
                        .waitSeconds(1)
                        .afterTime(0, new MotorAction(leftLevel,rightLevel,1300))
                        .waitSeconds(5)
                        .afterTime(0, new HolderAction(holder,0.6))
                        .afterTime(0, new HolderAction(holder,0.6))
                        .afterTime(0, new HolderAction(holder,0.6))
