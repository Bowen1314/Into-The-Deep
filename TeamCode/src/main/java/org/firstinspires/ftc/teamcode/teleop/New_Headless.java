...
@TeleOp(name = "Test_Headless", group = "AAA-First")
public class New_Headless extends OpMode {
    //declear all usage
    ...
    public void loop() {
        ...
        frontLeft.setPower(mutispeed * frontLeftPower);
        frontRight.setPower(mutispeed * frontRightPower);
        backLeft.setPower(mutispeed * backLeftPower);
        backRight.setPower(mutispeed * backRightPower);
