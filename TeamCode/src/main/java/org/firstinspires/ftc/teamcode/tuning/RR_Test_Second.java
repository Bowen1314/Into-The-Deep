...
@Autonomous(name = "AAA - Test Second", group = "A-RR")
public final class RR_Test_Second extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Actions.runBlocking(
                drive.actionBuilder(beginPose)
                        ...
                        .waitSeconds(1)
                        .strafeToSplineHeading(new Vector2d(-5,30), Math.toRadians(90))
                        .waitSeconds(1)
                        .afterTime(0, new MotorAction(leftLevel,rightLevel,600))
                        .afterTime(.5, new HolderAction(holder,0.6))
                        .afterTime(.5,new MotorAction(leftLevel,rightLevel,0))
                        .lineToY(41)
                        ...
                        .strafeToSplineHeading(new Vector2d(-24, 0), Math.toRadians(0))
                        .build()
        );
    }
