...
@Autonomous(name = "A-RR_New", group = "A-RR")
public final class RR_New extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        // 初始位姿
        Pose2d beginPose = new Pose2d(-14, 62,-179);
        ...
        Actions.runBlocking(
                drive.actionBuilder(beginPose)
                        //.afterTime(0,new MotorAction(leftLevel,rightLevel,2000))
                        .strafeToSplineHeading(new Vector2d(-5,38), Math.toRadians(90))
                        .lineToY(41)
                        .afterTime(0,new MotorAction(leftLevel,rightLevel,0))
                        .strafeToSplineHeading(new Vector2d(-34, 40), Math.toRadians(90))
                        //.splineTo(new Vector2d(-37, 20), Math.toRadians(-90))
                        .strafeToSplineHeading(new Vector2d(-34, 0), Math.toRadians(90))
                        .strafeToSplineHeading(new Vector2d(-45, 0), Math.toRadians(90))                        //.lineToX(-48)

                        .strafeToSplineHeading(new Vector2d(-45, 55), Math.toRadians(90))
                        .strafeToSplineHeading(new Vector2d(-45, 10), Math.toRadians(90))
                        .strafeToSplineHeading(new Vector2d(-55, 10), Math.toRadians(90))
                        .strafeToSplineHeading(new Vector2d(-55, 55), Math.toRadians(90))
                        .strafeToSplineHeading(new Vector2d(-55, 10), Math.toRadians(90))
                        .strafeToSplineHeading(new Vector2d(-62, 10), Math.toRadians(90))
                        ...
                        .strafeToSplineHeading(new Vector2d(-14, 62), Math.toRadians(179))
