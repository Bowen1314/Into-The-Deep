...
@Autonomous(name = "AAA - RightSide Auto", group = "A-RR")
public final class RR_Right extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Actions.runBlocking(
                drive.actionBuilder(beginPose)
                        ...
                        .strafeToSplineHeading(new Vector2d(-38, 40), Math.toRadians(90))
                        //.splineTo(new Vector2d(-37, 20), Math.toRadians(-90))
                        .strafeToSplineHeading(new Vector2d(-38, 12), Math.toRadians(90))
                        ...
                        .strafeToSplineHeading(new Vector2d(-55, 12), Math.toRadians(90))
                        .strafeToSplineHeading(new Vector2d(-62, 12), Math.toRadians(90))
