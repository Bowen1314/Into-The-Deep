    ...
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity Blue = new DefaultBotBuilder(meepMeep)
                ...
                .followTrajectorySequence(drive -> drive.trajectorySequenceBuilder(new Pose2d(14, -62, Math.toRadians(90)))
                        ...
                        .splineToConstantHeading(new Vector2d(35, -15), Math.toRadians(90.00))
                        .splineToConstantHeading(new Vector2d(48, -15), Math.toRadians(270.00))
                        .splineToConstantHeading(new Vector2d(48.00, -55), Math.toRadians(90.00))
                        .splineToConstantHeading(new Vector2d(48.00, -15.00), Math.toRadians(90))
                        .splineToConstantHeading(new Vector2d(50.00, -15.00), Math.toRadians(270.00))
                        .splineToConstantHeading(new Vector2d(50.00, -55.00), Math.toRadians(90.00))
                        .splineToConstantHeading(new Vector2d(50.00, -15.00), Math.toRadians(90.00))
                        .splineToConstantHeading(new Vector2d(60.00, -15.00), Math.toRadians(270.00))
